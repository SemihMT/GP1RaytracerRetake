...
namespace dae {
	...
	{
		Matrix translation{Vector4{1   ,0             ,0              ,x},
						   Vector4{0   ,1             ,0              ,y},
						   Vector4{0   ,0             ,1              ,z},
						   Vector4{0   ,0             ,0              ,1}};
	...
	{
		Matrix pitchMatrix{Vector4{1   ,0             ,0              ,0},
	...
	{
		Matrix yawMatrix{Vector4{cosf(yaw) ,0   ,-sinf(yaw)   ,0},
						 Vector4{0         ,1   ,0           ,0},
	...
	{
		Matrix rollMatrix{Vector4{cosf(roll)    ,sinf(roll)  ,0  ,0},
	...
	{
		Matrix scaleMatrix{Vector4{sx   ,0    ,0  ,0},
						  Vector4{0     ,sy   ,0  ,0},
						  Vector4{0     ,0    ,sz ,0},
						  Vector4{0     ,0    ,0  ,1}};
		return {scaleMatrix};
